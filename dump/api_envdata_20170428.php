...
if ($enddate){
    $query_crit=$query_crit.$con."measuementDateTime<'".$enddate."' ";
    $con=" and ";
}
if ($startdate){
...
while($row0 = $result0->fetch_assoc()){
    ...
    if($calltype=="data" || $calltype=="datastream"){
        ...
        $query1="SELECT distinct datastream.datastreamID,variableName,variableUnit,baseTime,measurementDateTime,samplingProtocol ".$query_join.$query_crit." and location.locationID='".$locationID."'";
//    echo $query1."<br>";
        ...
        while($row1 = $result1->fetch_assoc()){
            ...
            $datastack=array();
            if ($calltype=="data"){
                $query2="select measurementDateTime,measurementValue,qcCode ".$query_join." and datastream.datastreamID='{$datastreamID}'";
//            echo $query2."<br>";
