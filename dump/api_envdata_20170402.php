...
while($row0 = $result0->fetch_assoc()){
    ...
    if($calltype=="data"){
        ...
        $query1="SELECT distinct datastream.datastreamID,measurementDateTime,samplingProtocol, ".$query_join.$query_crit." and dataset.datasetID='{$datasetID}' and location.locationID='".$locationID."'";
#    echo $query1."<br>";
        ...
        #populate valuestack (actual data) if required
            $query2="select ID,measurementType ".$query_join." and datastream.datastreamID='{$eventID}'";
            echo $query2."<br>";
            if ($taxonID){
