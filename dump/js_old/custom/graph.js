function loadPlot(datastream, graphType, isFirst){
// find first and last date of record and other information from metadata call
    ...
    //populates graph controlbox
        txt="<div id=graphMenu><div class=graphMenuItem id=timeseries>Show one long time series</div><div class='graphMenuItem' id=compareyearscumsum>Show year-by-year cumulative</div><div class=graphMenuItem id=compareyearsnormal>Show year-by-year</div></div><hr><div id=graphMenuAux></div>";
